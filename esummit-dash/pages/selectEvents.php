...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
        <div class="container-fluid">
          <!-- Brand -->
          <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="#">Choose Events</a>
          <!-- Form -->
        ...
        <div class="col">
          <div class="card shadow">
            <div class="card-header border-0">
              <h2 class="mb-0">Choose Event Day-1</h2>
            </div>
              ...
              <table class="table align-items-center table-flush">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="radio">
                        <input type="radio" name="D1" value="D1E1">
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="radio">
                        <input type="radio" name="D1" value="D1E2">
                      </div>
                    </td>
                  </tr>
                </tbody>
        ...
        <div class="col">
          <div class="card bg-default shadow">
            <div class="card-header bg-transparent border-0">
              <h2 class="text-white mb-0">Choose Event Day-2</h2>
            </div>
            <div class="table-responsive">
              <table class="table align-items-center table-dark table-flush">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      <div class="radio">
                        <input type="radio" name="D2" value="D2E1">
                      </div>
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td>
                      <div class="radio">
                        <input type="radio" name="D2" value="D2E2">
                      </div>
                    </td>
                  </tr>
                </tbody>
