...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./newadmin.html">Add New Admin</a>
        <!-- Form -->
        <!-- User -->
  ...
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input type="email" class="form-control"id="exampleFormControlInput1" value="" placeholder="name.kiitecell@gmail.com">
      </div>
    </div>
    <div class="col-md-6">
      <div class="form-group">
  ...
  <center>
  <button type="button" class="btn btn-primary mt-4">Create Admin</button>
  </center>
</form>
            </div>
          </div>
