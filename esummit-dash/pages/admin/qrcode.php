...
<body>
  ...
  <nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
    <div class="container-fluid">
      ...
      <!-- Brand -->
      <a class="navbar-brand pt-0" href="http://www.ecell.org.in"target="new">
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./newadmin.html">View User Profile Via QR Code</a>
        <!-- Form -->
        <!-- User -->
          ...
          <div class="card bg-secondary shadow border-0">
            ...
            <div class="card-body px-lg-5 py-lg-5">
              <div class="text-center text-muted mb-4">
                <small>Enter QR Code to Fetch Profile Details.</small>
              </div>
              <form method="get">
                <label class="form-control-label">QR CODE<font color="red">*</font></label>
                <div class="form-group mb-3">
                  <div class="input-group input-group-alternative">
                    
                    <input class="form-control" placeholder="ID1706000" type="text">
                  </div>
                </div>
                <div class="text-center">
                  <button type="button" class="btn btn-primary my-4">Show Profile</button>
                </div>
              </form>
            </div>
          </div>
