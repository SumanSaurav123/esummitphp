...
<body>
  ...
  <div class="main-content">
    ...
    <nav class="navbar navbar-top navbar-expand-md navbar-dark" id="navbar-main">
      <div class="container-fluid">
        <!-- Brand -->
        <a class="h4 mb-0 text-white text-uppercase d-none d-lg-inline-block" href="./admin.html">Admin</a>
        <!-- Form -->
        <!-- User -->
    ...
    <div class="header bg-gradient-primary pb-8 pt-5 pt-md-8">
      <div class="container-fluid">
		...
		<h2 align="center"><b>Hey!! Please select an option from side panel.</b></h2>
    <!-- Page content -->
